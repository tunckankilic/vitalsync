...
class WeeklyReportModel extends WeeklyReport {
  const WeeklyReportModel({
    ...
    super.takenMedicationsCount,
    super.skippedMedicationsCount,
    super.previousMedicationCompliance,
    super.previousSymptomsLoggedCount,
    ...
    super.dailyVolumes,
    super.previousDailyVolumes,
    super.previousWorkoutCount,
    super.bestWorkoutName,
    super.bestWorkoutVolume,
    super.exerciseNames,
  ...
  factory WeeklyReportModel.fromEntity(WeeklyReport entity) {
    return WeeklyReportModel(
      ...
      takenMedicationsCount: entity.takenMedicationsCount,
      skippedMedicationsCount: entity.skippedMedicationsCount,
      previousMedicationCompliance: entity.previousMedicationCompliance,
      previousSymptomsLoggedCount: entity.previousSymptomsLoggedCount,
      ...
      dailyVolumes: entity.dailyVolumes,
      previousDailyVolumes: entity.previousDailyVolumes,
      previousWorkoutCount: entity.previousWorkoutCount,
      bestWorkoutName: entity.bestWorkoutName,
      bestWorkoutVolume: entity.bestWorkoutVolume,
