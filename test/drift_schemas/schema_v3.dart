...
class CalibrationMetrics extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  CalibrationMetrics(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<int> mealsLogged = GeneratedColumn<int>(
    'meals_logged',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  late final GeneratedColumn<int> glucoseReadings = GeneratedColumn<int>(
    'glucose_readings',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  late final GeneratedColumn<int> manualReadings = GeneratedColumn<int>(
    'manual_readings',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  late final GeneratedColumn<int> coveredMeals = GeneratedColumn<int>(
    'covered_meals',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  late final GeneratedColumn<String> uncoveredReasons = GeneratedColumn<String>(
    'uncovered_reasons',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'calibration_metrics';
  @override
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  Never map(Map<String, dynamic> data, {String? tablePrefix}) {
  ...
  @override
  CalibrationMetrics createAlias(String alias) {
    return CalibrationMetrics(attachedDatabase, alias);
  }
...
class GlucoseReadings extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  GlucoseReadings(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
    aliasedName,
    false,
  ...
  @override
  GlucoseReadings createAlias(String alias) {
    return GlucoseReadings(attachedDatabase, alias);
  }
...
class DatabaseAtV3 extends GeneratedDatabase {
  ...
  late final CalibrationMetrics calibrationMetrics = CalibrationMetrics(this);
  ...
  late final GlucoseReadings glucoseReadings = GlucoseReadings(this);
  ...
  late final Index idxGlucoseReadingsExternalId = Index(
    'idx_glucose_readings_external_id',
    'CREATE UNIQUE INDEX idx_glucose_readings_external_id ON glucose_readings (external_id)',
  );
  late final Index idxHealthSamplesExternalId = Index(
    'idx_health_samples_external_id',
    'CREATE UNIQUE INDEX idx_health_samples_external_id ON health_samples (external_id)',
  );
  @override
  ...
  List<DatabaseSchemaEntity> get allSchemaEntities => [
    ...
    achievements,
    generatedInsights,
    idxGlucoseReadingsExternalId,
    idxHealthSamplesExternalId,
  ];
  @override
